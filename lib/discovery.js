...
module.exports.on("status", (data, ack) => {
	module.exports.signAck(ack, {
		success: true,
		data: {
			status: "green",
...
module.exports.on("update satoshi", (data, ack) => {
	streams.updateSatoshi(data.streamId, data.satoshi)
	.then(() => {
		module.exports.signAck(ack, {
			success: true
		});
...
module.exports.on("timeout", (data, ack) => {
